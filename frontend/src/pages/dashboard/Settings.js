...
const Settings = () => {
    ...
    const [userData, setUserData] = useState({
        name: '', email: '', phoneNumber: '', location: '', bio: '',
    });
                ...
                <div className="space-y-2">
                    {tabs.map((tab) => {
                        ...
                        return (<button
                                ...
                                className={`flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm transition-colors ${isActive ? 'bg-blue-100 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-100'}`}
                            >
